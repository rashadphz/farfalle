...
[![Deploy to PandaStack](https://dashboard.pandastack.io/deploy-button.svg)](https://dashboard.pandastack.io/deploy?repo=rashadphz/farfalle&type=static&buildCmd=npm+run+build&outputDir=dist)
